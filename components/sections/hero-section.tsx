...
export function HeroSection() {
  return (
    <section className="relative overflow-hidden px-5 pb-20 pt-16 sm:px-8 sm:pb-24 sm:pt-20 lg:px-10 lg:pb-28">
      <div className="absolute inset-x-0 top-0 -z-10 h-[560px] bg-[radial-gradient(circle_at_top,rgba(255,193,7,0.28),transparent_38%),radial-gradient(circle_at_85%_20%,rgba(76,175,80,0.18),transparent_24%),linear-gradient(180deg,rgba(255,255,255,0.92),rgba(250,250,250,0.9))]" />
      <div className="absolute left-1/2 top-12 -z-10 h-72 w-72 -translate-x-1/2 rounded-full bg-[rgba(255,152,0,0.18)] blur-3xl" />
      ...
      <div className="mx-auto grid w-full max-w-7xl gap-14 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
        <div>
          ...
          <h1 className="mt-8 max-w-4xl text-5xl font-semibold leading-[1.05] tracking-tight text-[var(--color-text-primary)] sm:text-6xl lg:text-7xl">
        ...
        <div className="relative">
          ...
          <div className="rounded-[2rem] border border-white/80 bg-white/72 p-6 shadow-[0_30px_70px_rgba(44,62,80,0.12)] backdrop-blur-xl">
            <div className="rounded-[1.5rem] bg-[linear-gradient(145deg,rgba(255,248,225,0.96),rgba(255,255,255,0.96))] p-7">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[var(--color-text-secondary)]">
                    Daily wisdom
                  </p>
                  <p className="mt-3 max-w-sm text-2xl font-semibold leading-9 text-[var(--color-text-primary)]">
